        ...
        >
          ...
          >
            ...
            <p className={styles.texto}>
              ...
              que se apresenta traz o enfoque para um novo encarreiramento. O
              itinerário foi elaborado a partir de 3 pilares:
            </p>
            <Collapse
              style={{
                display: "grid",
      ...
      >
        <Col style={{ paddingBottom: `${!screens.xs ? "40px" : "20px"}` }}>
          ...
          <p className={styles.texto} style={{}}>
            ...
            atitudes para solucionar problemas e lidar com situações cotidianas
            profissionais. Essas competências estão associadas e agrupadas por
            categorias, sendo elas: Envolvimento profissional, Recursos
            digitais, Ensino e aprendizagem, Avaliação, Capacitação dos
            aprendentes, Programação da competência digital dos aprendentes,
            Gestão de resultados, Gestão de relacionamentos, Gestão de mudanças,
            Orientação a resultados, Processos de melhoria, Transversais. Abaixo
            é apresentado o infográfico com a Mandala de Competências organizada
            pelas competências associadas em categorias.
          </p>
        </Col>
        <Col
          style={screens.lg ? { padding: "40px 0px" } : { padding: "20px 0px" }}
        >
          <Image
            src={infografico}
            preview={
